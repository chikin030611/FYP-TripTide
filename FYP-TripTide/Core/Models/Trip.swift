...
extension Trip {
    ...
    static let sampleTrip = Trip(
        id: "1",
        userId: "1",
        name: "Trip to Hong Kong From 10th to 12th March",
        ...
        touristAttractionsIds: Trip.touristAttractions.map { $0.id },
        restaurantsIds: Trip.restaurants.map { $0.id },
        lodgingsIds: Trip.lodgings.map { $0.id },
        startDate: Date(),
