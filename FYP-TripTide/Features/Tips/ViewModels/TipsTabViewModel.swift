...
let transportTip = Tip(
    ...
    author: "TripTide",
    publishDate: Date(),
    title: "Transport in Hong Kong",
    content: [
        .header("Introduction"),
        .text("Hong Kong is a city of contrasts..."),
